...
<html lang="en-US" dir="ltr">
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      <nav class="navbar navbar-custom navbar-fixed-top navbar-transparent" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="index.html">Dress2kill</a>
          </div>
          <div class="collapse navbar-collapse" id="custom-collapse">
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown"><a href="#" data-toggle="dropdown">Home</a>
                 <ul class="dropdown-menu">
                  <li class="dropdown"><a href="#" data-toggle="dropdown">Login</a>
                  </li>
                  <li class="dropdown"><a href="#" data-toggle="dropdown">Register</a>
                  </li>
           
                </ul>
              </li>
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Bespoke Tailoring</a>
                <ul class="dropdown-menu">
                  <li class="dropdown"><a href="#" data-toggle="dropdown">London Waterloo</a>
                  </li>
                  <li class="dropdown"><a href="#" data-toggle="dropdown">Whitchurch Hampshire</a>
                  </li>
           
                </ul>
             
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Designer</a>
                <ul class="dropdown-menu">
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Bespoke Suits</a>
                  </li>
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Wedding Suits</a>
                  </li>
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Tweed</a>
                  </li>
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Ladies Suits</a>
                  </li>
      ...
      <section class="home-section home-full-height" id="home" data-background="assets/images/bg.jpg">
        <div class="video-player" data-property="{videoURL:'https://youtu.be/T2QTzzTj_G8', containment:'.home-section', startAt:00, mute:false, autoPlay:true, loop:true, opacity:1, showControls:false, showYTLogo:false, vol:15}"></div>
        ...
        <div class="titan-caption">
          <div class="caption-content">
            <div class="font-alt mb-40 titan-title-size-4" style='color:white'>The UK's Leading Bespoke Tailors </div><button class="section-scroll btn btn-border-w btn-round" style='color:black;background-color:white;' >
 <script src ="https://form.jotformeu.com/static/feedback2.js" type="text/javascript"></script><script type="text/javascript"> var JFL_73493510991361 = new JotformFeedback({ formId: '73493510991361', base: 'https://form.jotformeu.com/', windowTitle: 'Book An Appointment', background: '#FFA500', fontColor: '#FFFFFF', type: 'false', height: 500, width: 700, openOnLoad: false }); </script> <a class="btn lightbox-73493510991361" style='font-size:1.3em;'> Book An Appointment </a></button>
          </div>
        </div>
      </section>
      <div class="main">
        ...
        <section class="module bg-dark-60" data-background="assets/images/section-6.jpg">
          <div class="container">
            <div class="row">
              <div class="col-sm-12">
                <div class="video-box">
                  <div class="video-box-icon"><a class="video-pop-up" href="https://www.youtube.com/watch?v=T2QTzzTj_G8"><span class="icon-video"></span></a></div>
